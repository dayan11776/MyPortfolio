            ...
            <div className="flex items-center"> 
                {github &&
                    <Link to={github}  target="_blank">
                        <svg className="w-12 h-12 border p-2 mr-2 rounded-xl border-gray-700 text-gray-800 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                ...
                <Link to={netlify}  target="_blank">
                    <svg className="w-12 h-12 border p-2 rounded-xl border-gray-700 text-gray-800 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
