        ...
        <div className="flex justify-around mt-12 max-sm:flex-col max-sm:w-full  max-sm:items-center max-lg:flex-col max-lg:w-full  max-lg:items-center">
            ...
            <div className="w-3/5 flex flex-col justify-center max-sm:w-full max-sm:items-center max-lg:w-full max-lg:items-center">
                ...
                <div className="flex max-sm:mb-7 max-lg:mb-7">
                    <Link to="https://www.linkedin.com/in/bryan-tapel-876271198/" target="_blank" className="text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 me-2 mb-2 max-sm:px-4">
                    ...
                    <Link to="https://github.com/dayan11776" target="_blank" className="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-gray-500 me-2 mb-2 max-sm:px-4">
                    ...
                    <Link to="https://www.facebook.com/bryan.tapel" target="_blank" className="text-white bg-[#3b5998] hover:bg-[#3b5998]/90 focus:ring-4 focus:outline-none focus:ring-[#3b5998]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#3b5998]/55 me-2 mb-2 max-sm:px-4">
                    ...
                    <Link to="https://mail.google.com/mail/u/0/?fs=1&to=bryantapel619@gmail.com&su=Hey+Bryan!&tf=cm" target="_blank" className="text-white bg-red-900 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 me-2 mb-2 max-sm:me-0 max-sm:px-4">
