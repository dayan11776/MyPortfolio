...
export const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_bit1gwj', 'template_0oxnnh8', form.current, {
  ...
  return (
     <div className="max-lg:px-7" id='Contact'>
        <div className='mb-7 max-sm:text-center max-lg:text-center'>
            <p className="mb-2 text-blue-700 text-lg">Let's talk</p>
        ...
        <div className="flex flex-wrap justify-between max-sm:flex-col max-lg:flex-col">
            ...
            <div className="dark:text-white rounded-3xl shadow-sm px-7 bg-white w-1/2 flex flex-col justify-around dark:bg-gray-800 max-sm:w-full max-sm:text-center max-sm:items-center max-sm:py-3 max-sm:rounded-none max-lg:w-full max-lg:text-center max-lg:items-center max-lg:py-3">
              ...
              <div className='h-44 w-44 p-3 border rounded-full max-sm:mb-3 max-lg:mb-3'>
                <img className='rounded-full' src="./assets/profile/profile.jpg" alt="profile" />
              </div>
              <div className='mb-3'>
                <p>My inbox is always open, Whether you have a project or just want to say Hi. I would love to hear from you. Feel free to contact me and I'll get back to you.</p>
              </div>
              <div className='flex'>
