...
export const SideNavbar = () => {
    ...
    const [sideNavigate,setSideNavigate] = useState(false)
  ...
  return (
    <React.Fragment>
        <button onClick={() => setSideNavigate(!sideNavigate)} data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar" type="button" className={`${sideNavigate?"translate-x-0":"translate-x-64"} inline-flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600`}>
        ...
        <aside id="logo-sidebar" className={`${sideNavigate?"-translate-x-full":"translate-x-0"} fixed top-0 left-0 z-40 w-64 h-screen transition-transform border-white sm:translate-x-0 `} aria-label="Sidebar">
